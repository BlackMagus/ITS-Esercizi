  ...
  <div className="container mt-5">
    <div className="row mb-3">
      <div className="col">
        ...
        <select id="marca" name="marca" className="form-select" value = {marca} onChange={(e)=> setMarca(e.target.value)}>
    ...
    <div className="row">
      <div className="col">
        ...
        <select id="modello" name="modello" className="form-select" disabled= {!marca}>
          <option value="">Seleziona modello</option>

            {
            modelli.map((m)=> {
                return (<option value = {modelli}>{m}</option>)
            })
         }
        </select>
      </div>
...
export default SelectMarcaModello